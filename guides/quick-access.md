...
| Besoin | Document |
|--------|----------|
| **Vue d'ensemble** | [README.md](README)) |
| **Démarrage rapide** | [QUICKSTART.md](QUICKSTART)) |
| **Installation réussie** | [INSTALLATION-SUCCESS.md](INSTALLATION-SUCCESS)) |
| **Architecture** | [ARCHITECTURE-DIAGRAMS.md](ARCHITECTURE-DIAGRAMS)) |
| **Commandes Git** | [GIT-COMMANDS.md](GIT-COMMANDS)) |
| **Récapitulatif** | [RECAP-FINAL.md](RECAP-FINAL)) |
| **Backend** | [docs/phenom-backend-architecture-v2.md](docs/phenom-backend-architecture-v2)) |
| **Frontend** | [docs/phenom-frontend-architecture.md](docs/phenom-frontend-architecture)) |
| **Design** | [docs/phenom-design-system.md](docs/phenom-design-system)) |
| **Docker/Deploy** | [docs/phenom-docker-deployment-guide.md](docs/phenom-docker-deployment-guide)) |
