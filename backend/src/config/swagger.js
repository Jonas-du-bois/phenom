...
/**
 * Defines schemas, security, and API metadata for the Phenom API.
 */
...
const options = {
  definition: {
    openapi: '3.0.0',
    // API metadata and general information
    info: {
      title: 'Phenom API',
      version: '1.0.0',
...
`,
    ...
    // Reusable components (security schemes and data schemas)
    components: {
      ...
      securitySchemes: {
        bearerAuth: {
          ...
          bearerFormat: 'JWT',
          description:
            'Token JWT pour l\'authentification. Utilisez ce schéma pour les routes nécessitant une authentification.'
        }
      },
      // Data model schemas for request/response validation
      schemas: {
        ...
        // UFO observation schema (Phenom Search compatible)
        Observation: {
          type: 'object',
          description:
            'Observation OVNI (format Phenom App avec support Phenom Search)',
          properties: {
            _id: {
              type: 'string'
            },
            ...
            description: {
              type: 'string',
              example:
                'Observation d\'un objet triangulaire lumineux au-dessus de la ville'
            },
            credibility: {
              type: 'integer',
              ...
              items: {
                ...
                properties: {
                  publicId: {
                    ...
                    example:
                      'phenom/observations/507f1f77bcf86cd799439011_1699876543210'
                  },
                  url: {
                    type: 'string',
                    description: 'URL HTTPS publique sur Cloudinary',
                    example:
                      'https://res.cloudinary.com/dgsfd1fic/image/upload/v1699876543/phenom/observations/507f1f77bcf86cd799439011_1699876543210.jpg'
                  },
                  size: {
                    type: 'number',
    ...
    // API endpoint groupings for documentation
    tags: [
      {
        name: 'Observations',
        description:
          'Gestion des observations OVNI - Format Phenom Search compatible. Lecture publique, création/modification authentifiée.'
      },
      {
        name: 'Filters',
        description:
          'Valeurs de filtres disponibles pour la recherche (pays, locales, types d\'observateurs, formes, phénomènes)'
      },
      {
        name: 'Authentication',
...
// Generate and export Swagger specification from options
