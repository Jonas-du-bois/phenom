  ...
  <form @submit.prevent="handleSubmit" class="login-form space-y-6">
    ...
    <div class="text-center mb-8">
      <div class="flex items-center gap-2 justify-center mb-4">
            <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 174 174" fill="none" class="flex-shrink-0">
    ...
    <p class="text-center text-white/60">
      ...
      <router-link to="/signup" class="text-[#00F0FF] font-medium hover:underline">
        S'inscrire
      </router-link>
    </p>
  </form>
