...
const props = defineProps({
  ...
  icon: {
    type: String,
    default: 'search',
    validator: (v) => ['search', 'observations', 'comments', 'alerts', 'map'].includes(v)
  },
  showAction: {
    type: Boolean,
    default: false
...
<template>
  <div class="flex flex-col items-center justify-center py-12 px-4 text-center">
    ...
    <div class="w-16 h-16 mb-6 text-white/20">
      ...
      <!-- Observations Icon -->
      <svg v-else-if="icon === 'observations'" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
      ...
      <!-- Comments Icon -->
      <svg v-else-if="icon === 'comments'" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
        <path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z" />
      </svg>
      
      <!-- Alerts Icon -->
      <svg v-else-if="icon === 'alerts'" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
