    ...
    <div class="flex items-center gap-3">
      ...
      <div class="relative flex-1">
        <input
          ...
          @input="handleInput"
        />
        <span class="absolute right-4 top-1/2 -translate-y-1/2 text-white/40 text-sm">
          sec
        </span>
      </div>
      
      <!-- Formatted Display -->
      <div class="px-3 py-2 bg-[#00F0FF]/10 border border-[#00F0FF]/30 text-[#00F0FF] text-sm font-mono min-w-[100px] text-center">
        {{ formattedDuration }}
      </div>
    </div>
