...
<template>
  ...
  >
    <div class="text-center">
      ...
      <div class="mb-8">
        <div
          class="w-32 h-32 mx-auto rounded-full bg-gradient-to-br from-[#00F0FF]/20 to-[#0066CC]/20 flex items-center justify-center"
        >
          <svg
            class="w-16 h-16 text-[#00F0FF]"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
      ...
      <h2 class="text-xl font-semibold text-white mb-2">Page introuvable</h2>
