    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900">
          🧪 Page de Test - Observations
        </h1>
        <p class="mt-2 text-gray-600">
          Démonstration des observations avec photos et commentaires
        </p>
      </div>
      ...
      <div v-if="!loading && observations.length > 0" class="space-y-6">
        ...
        >
          ...
          <div class="p-6 border-b border-gray-200">
            ...
            <div class="mt-4 flex flex-wrap gap-4 text-sm text-gray-500">
              ...
              >
                ...
                {{ observation.location.coordinates[1].toFixed(4) }},
                {{ observation.location.coordinates[0].toFixed(4) }}
                <svg
                  class="w-3 h-3 ml-1"
                  fill="currentColor"
                  viewBox="0 0 20 20"
          ...
          <!-- Photos -->
          <div
            v-if="observation.images?.length"
          ...
          <div class="p-6">
            ...
            >
              ...
              Commentaires ({{
                observationComments[observation._id]?.length || 0
              }})
            </h3>

            <!-- Liste des commentaires -->
            <div
              v-if="observationComments[observation._id]?.length"
              class="space-y-4"
            >
              <div
      ...
      <div
        v-else-if="!loading && observations.length === 0"
      ...
      >
        ...
        <p class="mt-1 text-sm text-gray-500">
          Commencez par créer une observation.
        </p>
      </div>
    </div>
  </div>
...
const { commentsByObservation: observationComments, loadComments } =
  useComments();
...
const totalComments = computed(() => {
  return Object.values(observationComments.value).reduce(
...
const getCommentInitials = (comment) => {
  const userName =
    comment.userId?.name || comment.author?.name || "Utilisateur";
